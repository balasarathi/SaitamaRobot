A modular Telegram Python bot running on python3 with a sqlalchemy database and an entirely themed persona to make Saitama suitable for Anime and Manga group chat
.
...
News channel as at [flowerbot and vicky Updates](https://t.me/vickyorflowerbotsupport) 

## How to setup/deploy.

### Read these notes carefully before proceeding 
 - Edit any mentions of @vickyorflowerbotsupport to your own support chat
 - Your code must be open source and a link to your fork's repository must be there in the start reply of the bot [See all the repository](https://github.com/balasarathi
...
class Development(Config):
    ...
    OWNER_USERNAME = "balasarathi"  # your telegram username
